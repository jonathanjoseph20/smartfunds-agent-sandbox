...
import { createMissionCoordinationMaterializer } from '../mission-control/mission-coordination-materializer.ts';
...
export async function main(argv: string[] = process.argv.slice(2)): Promise<number> {
  try {
    ...
    printJson(createMissionCoordinationMaterializer().materializeOne(args));
    return 0;
  } catch (error) {
